...
class Student:
    def __init__(self, root):
        ...
        img = img.resize((500, 130), PIL.Image.Resampling.LANCZOS)  # High level img to Low level img
        ...
        img1 = img1.resize((500, 130), PIL.Image.Resampling.LANCZOS)  # High level img to Low level img
        ...
        img2 = img2.resize((530, 130), PIL.Image.Resampling.LANCZOS)  # High level img to Low level img
        ...
        bg = bg.resize((1530, 710), PIL.Image.Resampling.LANCZOS)  # High level img to Low level img
        ...
        title_lb = Label(bg_image, text="STUDENT MANAGEMENT SYSTEM", font=("PT Serif", 35, "bold"), bg="#163b06",
                         fg="#e6f2e1")
        ...
        left_frame = LabelFrame(main_frame, bd=2, bg="#f0ecdf", relief=RIDGE, text="Student Details",
                                font=("time new roman", 13, "bold"))
        left_frame.place(x=10, y=10, width=745, height=580)

        img_lf = Image.open("Images/attendance.jpg")
        img_lf = img_lf.resize((730, 130), PIL.Image.Resampling.LANCZOS)  # High level img to Low level img
        ...
        # current course
        current_course_frame = LabelFrame(left_frame, bd=2, bg="#f0ecdf", relief=RIDGE,
                                          text="Current Course Information", font=("time new roman", 13, "bold"))
        ...
        course_combo = ttk.Combobox(current_course_frame, textvariable=self.var_course,
                                    font=("time new roman", 12, "bold"), state="readonly", width=20)
        ...
        sem_combo = ttk.Combobox(current_course_frame, textvariable=self.var_sem, font=("time new roman", 12, "bold"),
                                 state="readonly", width=20)
        ...
        class_student_frame = LabelFrame(left_frame, bd=2, bg="#f0ecdf", relief=RIDGE, text="Student Information",
                                         font=("time new roman", 13, "bold"))
        class_student_frame.place(x=10, y=250, width=720, height=305)

        # Student Id
        studentId_label = Label(class_student_frame, text="Student ID:", font=("time new roman", 12, "bold"),
                                bg="#f0ecdf")
        ...
        studentName_entry = ttk.Entry(class_student_frame, textvariable=self.var_std_name, width=22,
                                      font=("time new roman", 12, "bold"))
        studentName_entry.grid(row=0, column=3, padx=10, pady=5, sticky=W)

        # Student Email
        studentEmail_label = Label(class_student_frame, text="Student Email:", font=("time new roman", 12, "bold"),
                                   bg="#f0ecdf")
        studentEmail_label.grid(row=1, column=0, padx=10, pady=5, sticky=W)

        studentEmail_entry = ttk.Entry(class_student_frame, textvariable=self.var_std_email, width=20,
                                       font=("time new roman", 12, "bold"))
        studentEmail_entry.grid(row=1, column=1, padx=10, pady=5, sticky=W)

        # Gender
        studentGender_label = Label(class_student_frame, text="Gender:", font=("time new roman", 12, "bold"),
                                    bg="#f0ecdf")
        studentGender_label.grid(row=1, column=2, padx=10, pady=5, sticky=W)

        studentGender_combo = ttk.Combobox(class_student_frame, textvariable=self.var_gender, state="readonly",
                                           font=("time new roman", 12, "bold"))
        ...
        PhoneNo_entry = ttk.Entry(class_student_frame, textvariable=self.var_phone_no, width=20,
                                  font=("time new roman", 12, "bold"))
        ...
        address_entry = ttk.Entry(class_student_frame, textvariable=self.var_add, width=22,
                                  font=("time new roman", 12, "bold"))
        address_entry.grid(row=2, column=3, padx=10, pady=5, sticky=W)

        # Father/Gardian Name
        Father_Gardian_Name = Label(class_student_frame, text="Father/Gardian:", font=("time new roman", 12, "bold"),
                                    bg="#f0ecdf")
        Father_Gardian_Name.grid(row=3, column=0, padx=10, pady=5, sticky=W)

        Father_Gardian_Name = ttk.Entry(class_student_frame, textvariable=self.var_ForG, width=20,
                                        font=("time new roman", 12, "bold"))
        ...
        Mentor = ttk.Entry(class_student_frame, textvariable=self.var_mentor, width=22,
                           font=("time new roman", 12, "bold"))
        ...
        update_btn = Button(btn_frame, text="Update", command=self.update_data, width=15,
                            font=("time new roman", 12, "bold"), bg="grey", fg="white")
        ...
        # take photo btn
        take_photo_btn = Button(btn_frame_2, text="Take Photo", command=self.generate_dataset, width=32,
                                font=("time new roman", 12, "bold"), bg="grey", fg="white")
        ...
        right_frame = LabelFrame(main_frame, bd=2, bg="#f0ecdf", relief=RIDGE, text="Student Details",
                                 font=("time new roman", 12, "bold"))
        right_frame.place(x=765, y=10, width=725, height=580)

        img_rt = Image.open("Images/attendance2.jpg")
        img_rt = img_rt.resize((700, 125), PIL.Image.Resampling.LANCZOS)  # High level img to Low level img
        ...
        search_frame = LabelFrame(right_frame, bd=2, bg="#f0ecdf", relief=RIDGE, text="Search System",
                                  font=("time new roman", 13, "bold"))
        search_frame.place(x=5, y=135, width=705, height=70)

        Search = Label(search_frame, text="Search By:", font=("time new roman", 15, "bold"), bg="#f0ecdf",
                       fg="dark blue")
        ...
        search_btn = Button(search_frame, text="Search", width=10, font=("time new roman", 12, "bold"), bg="grey",
                            fg="white")
        search_btn.grid(row=0, column=3, padx=5)

        showAll_btn = Button(search_frame, text="Show All", width=10, font=("time new roman", 12, "bold"), bg="grey",
                             fg="white")
        ...
        self.student_table = ttk.Treeview(Table_frame,
                                          column=("dep", "course", "year", "sem", "Student_ID", "Student_Name",
                                                  "Student_Email", "Gender", "Phone_no", "Address", "Name(F/G)",
                                                  "D.O.B", "CGPA", "Mentor", "Photo", "Enrollment_No"),
    ...
    def add_data(self):
        if self.var_dep.get() == "Select Department" or self.var_course.get() == "Select Course" or self.var_year.get() == "Select Year" or self.var_sem.get() == "Select Semester" or self.var_std_id.get() == "" or self.var_std_name.get() == "" or self.var_std_email.get() == "" or self.var_gender.get() == "Select Gender" or self.var_dob.get() == "" or self.var_ForG.get() == "" or self.var_add.get() == "" or self.var_phone_no.get() == "" or self.var_roll.get() == "" or self.var_mentor.get() == "":
            ...
            try:
                conn = mysql.connector.connect(host='localhost', username='root', password='Adithya@1',
    ...
    ######################################### Fetch data #########################################
    def fetch_data(self):
        conn = mysql.connector.connect(host='localhost', username='root', password='Nandy#2005',
                                       database='face_recognition')
        my_cursor = conn.cursor()
    ...
    def generate_dataset(self):
        ...
        try:
            ...
            if not os.path.exists(harcascadePath):
                messagebox.showerror("Error", "Haar cascade file not found", parent=self.root)
                cam.release()
                return
            ...
            print("Taking photos... Look at the camera and wait for green rectangles")
            ...
            while True:
                ...
                for (x, y, w, h) in faces:
                    ...
                    cv2.imshow('Taking Photos - Press Q to quit', img)

                # Press 'Q' to exit or after taking 30 samples
            ...
            messagebox.showinfo("Result", f"Photo samples taken: {count}", parent=self.root)
