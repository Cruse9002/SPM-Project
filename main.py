...
class Face_Recognition_System:
    def __init__(self, root):
        ...
        title_lb = Label(bg_image, text="FACE RECOGNITION ATTENDANCE SYSTEM SOFTWARE", font=("PT Serif", 35, "bold"),
                         bg="#faffc7", fg="#f7520f")
        title_lb.place(x=0, y=0, width=1530, height=50)

        # Student Button
        std_1 = Image.open("Images/std_1.jpg")
        std_1 = std_1.resize((220, 220), PIL.Image.Resampling.LANCZOS)  # High level img to Low level img
        ...
        b1_txt = Button(bg_image, text="Student Details", command=self.student_details, cursor="hand2",
                        font=("PT Serif", 15, "bold"), bg="#040229", fg="white")
        b1_txt.place(x=200, y=300, width=220, height=40)

        # Detect Face
        face_1 = Image.open("Images/face_detect.jpg")
        face_1 = face_1.resize((220, 220), PIL.Image.Resampling.LANCZOS)  # High level img to Low level img
        ...
        b1_txt = Button(bg_image, text="Face Recognizer", command=self.face_data, cursor="hand2",
                        font=("PT Serif", 15, "bold"), bg="#040229", fg="white")
        b1_txt.place(x=500, y=300, width=220, height=40)

        # Attendance
        att = Image.open("Images/att.png")
        att = att.resize((220, 220), PIL.Image.Resampling.LANCZOS)  # High level img to Low level img
        ...
        b1_txt = Button(bg_image, text="Attendance", command=self.attendance_data, cursor="hand2",
                        font=("PT Serif", 15, "bold"), bg="#040229", fg="white")
        b1_txt.place(x=800, y=300, width=220, height=40)

        # Help Desk
        help = Image.open("Images/help_d.jpg")
        help = help.resize((220, 220), PIL.Image.Resampling.LANCZOS)  # High level img to Low level img
        ...
        b1_txt = Button(bg_image, text="Help Desk", command=self.help_data, cursor="hand2",
                        font=("PT Serif", 15, "bold"), bg="#040229", fg="white")
        b1_txt.place(x=1100, y=300, width=220, height=40)

        # Training the algo
        train = Image.open("Images/training.jpg")
        train = train.resize((220, 220), PIL.Image.Resampling.LANCZOS)  # High level img to Low level img
        ...
        b1_txt = Button(bg_image, text="Training data", command=self.train_data, cursor="hand2",
                        font=("PT Serif", 15, "bold"), bg="#040229", fg="white")
        b1_txt.place(x=200, y=580, width=220, height=40)

        # Data library
        #photos = Image.open("Images/store.jpg")
        #photos = photos.resize((220, 220), PIL.Image.Resampling.LANCZOS)  # High level img to Low level img
        ...
        #b1_txt = Button(bg_image, command=self.open_img, text="Image Library", cursor="hand2",
                        #font=("PT Serif", 15, "bold"), bg="#040229", fg="white")
        #b1_txt.place(x=500, y=580, width=220, height=40)

        # Developer info/Contact
        Dev = Image.open("Images/dev1.jpg")
        Dev = Dev.resize((220, 220), PIL.Image.Resampling.LANCZOS)  # High level img to Low level img
        ...
        b1_txt = Button(bg_image, text="Contact Developer", command=self.developer_data, cursor="hand2",
                        font=("PT Serif", 15, "bold"), bg="#040229", fg="white")
        b1_txt.place(x=800, y=580, width=220, height=40)

        # Exit Button
        Exit = Image.open("Images/exit.png")
        Exit = Exit.resize((220, 220), PIL.Image.Resampling.LANCZOS)  # High level img to Low level img
        ...
        b1_txt = Button(bg_image, text="Exit", command=self.isExit, cursor="hand2", font=("PT Serif", 15, "bold"),
                        bg="#040229", fg="white")
